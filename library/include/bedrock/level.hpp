#pragma once
#ifndef BEDROCK_LEVEL_H
#define BEDROCK_LEVEL_H
...
public:
	...
	std::vector<int32_t> getVersionId() const { return minecraftVersionId; }
...
private:
	...
	int64_t tick = 0;
	int64_t time = 0;
	std::vector<int32_t> minecraftVersionId;
